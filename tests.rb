...
class TestMaxProfit < MiniTest::Test
	...
	def test_simple_small_arr_efficient
		actual = MaxProfit.find_max_profit_efficient([1,2,3])
		assert_equal 2, actual  
	end

	def test_simple_small_arr_efficient_2
		actual = MaxProfit.find_max_profit_efficient([3,1,2])
		assert_equal 1, actual  
	end

	def test_simple_bigger_arr_efficient
		actual = MaxProfit.find_max_profit_efficient([5,4,3,10,9,8,1,2,7])
		assert_equal 7, actual
	end

	def test_difficult_small_arr_efficient
